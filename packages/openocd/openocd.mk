...
OPENOCD_SOURCE = ntfreak-openocd-v0.10.0-924-g1649648.tar.gz
#OPENOCD_SITE = http://sourceforge.net/projects/openocd/files/openocd/$(OPENOCD_VERSION)
OPENOCD_SITE = https://github.com/ntfreak/openocd/tarball/1649648
...
OPENOCD_CONF_OPTS += \
	...
	$(if $(BR2_PACKAGE_OPENOCD_IMX_GPIO),--enable-imx_gpio,--disable-imx_gpio ) \
